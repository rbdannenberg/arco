...
Compilation options: -lang cpp -light -ct 1 -cn Mult -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
public:
    ...
    void chan_ab_a(Mult_state *state) {
        ...
        for (int i0 = 0; i0 < BL; i0 = i0 + 1) {
            ...
            output0[i0] = FAUSTFLOAT(fSlow0_fast * float(input0[i0]));
        }
    }
    ...
    void chan_bb_a(Mult_state *state) {
        FAUSTFLOAT* output0 = out_samps;
        float fSlow0 = float(x1_samps[0]) * float(x2_samps[0]);
        Sample fSlow0_incr = (fSlow0 - state->fSlow0_prev) * BL_RECIP;
        Sample fSlow0_fast = state->fSlow0_prev;
        state->fSlow0_prev = fSlow0;
        for (int i0 = 0; i0 < BL; i0 = i0 + 1) {
            fSlow0_fast += fSlow0_incr;
            output0[i0] = FAUSTFLOAT(fSlow0_fast);
        }
    }
    ...
    void real_run() {
        ...
        Mult_state *state = states.get_array();
        for (int i = 0; i < chans; i++) {
