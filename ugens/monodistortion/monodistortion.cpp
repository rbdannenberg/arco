...
/* O2SM INTERFACE: /arco/monodistortion/new int32 id, int32 chans, int32 input, int32 gain, int32 tone, int32 volume;
 */
void arco_monodistortion_new(O2SM_HANDLER_ARGS)
{
    ...
    ANY_UGEN_FROM_ID(input_ugen, input, "arco_monodistortion_new");
    ...
    new Monodistortion(id, chans, input_ugen, gain_ugen, tone_ugen, volume_ugen);
}


/* O2SM INTERFACE: /arco/monodistortion/repl_input int32 id, int32 input_id;
 */
static void arco_monodistortion_repl_input(O2SM_HANDLER_ARGS)
{
    // begin unpack message (machine-generated):
    int32_t id = argv[0]->i;
    ...
    UGEN_FROM_ID(Monodistortion, monodistortion, id, "arco_monodistortion_repl_input");
    ANY_UGEN_FROM_ID(input, input_id, "arco_monodistortion_repl_input");
    monodistortion->repl_input(input);
}


/* O2SM INTERFACE: /arco/monodistortion/set_input int32 id, int32 chan, float val;
 */
static void arco_monodistortion_set_input (O2SM_HANDLER_ARGS)
{
    // begin unpack message (machine-generated):
    int32_t id = argv[0]->i;
    ...
    UGEN_FROM_ID(Monodistortion, monodistortion, id, "arco_monodistortion_set_input");
    monodistortion->set_input(chan, val);
}
...
static void monodistortion_init()
{
    ...
    o2sm_method_new("/arco/monodistortion/repl_input", "ii",
                    arco_monodistortion_repl_input, NULL, true, true);
    o2sm_method_new("/arco/monodistortion/set_input", "iif",
                    arco_monodistortion_set_input, NULL, true, true);
