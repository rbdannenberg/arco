// nopoly.cpp - based on Dannenberg and Thompson, CMJ, implements
//     unit generators in the style of Arco
//     Inputs have a fixed type: audio or block rate
//
// Roger B. Dannenberg
// Jan 2025
...
public:
    ...
    void real_run() {
        ...
        for (int i = 0; i < chans; i++) {
            Sample *table_ptr = table->get_array();
            ...
            for (int i = 0; i < BL; i++) {
                ...
                *out_samps++ = (table_ptr[ix] * (1 - frac) + 
                                table_ptr[ix + 1] * frac) * amp_sig_fast;
                phase += phase_incr;
                while (phase > 1) phase--;
                while (phase < 0) phase++;
            }
