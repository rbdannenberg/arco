...
void build_graph()
{
    ...
    vibosc_sineb = new Sineb(12, 1, vibfreq_pwl, vibamp_pwl);
    ...
    modfreq_math = new Math(14, 1, MATH_OP_ADD, freq_pwl, vibosc_sineb);
...
int main()
{
    ...
    printf("block_count is %d\nreal_run methods were called %ld times\n"
           " which is %g times per block.\n", block_count, real_run_count,
           (double) real_run_count / block_count);

#define RESULTS "block128cnt.txt"
#include "report.cpp"
}
