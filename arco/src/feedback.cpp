...
/* O2SM INTERFACE: /arco/feedback/new int32 id, int32 chans, int32 input_id;
 */
...
static void feedback_init()
{
    ...
    o2sm_method_new("/arco/feedback/new", "iii", arco_feedback_new, NULL,
                    true, true);
