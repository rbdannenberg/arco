...
/* O2SM INTERFACE: /arco/pweb/decay int32 id, float d;
 */
...
static void pweb_init()
{
    ...
    o2sm_method_new("/arco/pweb/start", "i", arco_pweb_start, NULL, true, true);
    o2sm_method_new("/arco/pweb/decay", "if", arco_pweb_decay, NULL, true, true);
